...
namespace BlackGoldProperties_API.Models
{
    ...
    public partial class BlackGoldPropertiesDBEntities : DbContext
    {
        public BlackGoldPropertiesDBEntities()
            : base("name=BlackGoldPropertiesDBEntities")
        {
        }
        ...
        public virtual DbSet<RENTALDOCUMENT> RENTALDOCUMENTs { get; set; }
        ...
        public virtual DbSet<USERLOGINTIMEOUT> USERLOGINTIMEOUTs { get; set; }
